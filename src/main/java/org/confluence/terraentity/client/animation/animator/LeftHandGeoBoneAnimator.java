...
public class LeftHandGeoBoneAnimator <T extends AbstractTerraNPC> extends AbstractGeoBoneAnimator<T> {
    ...
    private class UsingItemState extends HandGeoBoneState<T> {
        @Override
        protected void updateTransition(BoneStateMachine<BoneStates> state, T animatable, float partialTick, GeoBone bone, AnimatorContext context) {
