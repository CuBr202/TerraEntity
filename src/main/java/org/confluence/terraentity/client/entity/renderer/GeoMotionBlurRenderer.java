...
//        Minecraft.getInstance().renderBuffers().bufferSource().endBatch();
    ...
    public void renderFinal(PoseStack poseStack, T animatable, BakedGeoModel model, MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, float partialTick, int packedLight,
        ...
        super.renderFinal(poseStack, animatable, model, bufferSource, buffer, partialTick, packedLight, packedOverlay, r,g,b,a);
//        Minecraft.getInstance().renderBuffers().bufferSource().endBatch();
//        // 关闭模板写入（后续操作不影响模板缓冲区）
            ...
            if (renderer != null) {
                renderer.renderBlur(poseStack, animatable, partialTick, (color) -> {
                    ...
                    super.actuallyRender(poseStack, animatable, model,
                            ...
                            bufferSource, buffer, false, partialTick, packedLight, packedOverlay, (color >> 16) / 255.0f, (color >> 8 & 255) / 255.0f, (color & 255) / 255.0f, (color >> 24 & 255) / 255.0f );
                });
            }
