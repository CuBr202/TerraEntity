...
public class HumanoidRenderer<T extends Mob & GeoEntity & IUseItemAnimatable<BoneStates>> extends GeoNormalRenderer<T> {
    ...
    public static final String LEFT_BOOT_2 = DefaultBoneBoundIdents.LEFT_FOOT_ARMOR_BONE_2_IDENT;
    public static final String RIGHT_BOOT_2 = DefaultBoneBoundIdents.RIGHT_FOOT_ARMOR_BONE_2_IDENT;
    ...
    public static final String LEFT_ARMOR_LEG_2 = DefaultBoneBoundIdents.LEFT_LEG_ARMOR_BONE_2_IDENT;
    public static final String RIGHT_ARMOR_LEG_2 = DefaultBoneBoundIdents.RIGHT_LEG_ARMOR_BONE_2_IDENT;

    public static final String CHESTPLATE = DefaultBoneBoundIdents.BODY_ARMOR_BONE_IDENT;
    public static final String RIGHT_SLEEVE = DefaultBoneBoundIdents.RIGHT_ARM_ARMOR_BONE_IDENT;
    public static final String LEFT_SLEEVE = DefaultBoneBoundIdents.LEFT_ARM_ARMOR_BONE_IDENT;
