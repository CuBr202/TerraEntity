package org.confluence.terraentity.client.entity.model;// Made with Blockbench 4.12.5
...
public class DemonScytheModel<T extends Entity> extends EntityModel<T> {
