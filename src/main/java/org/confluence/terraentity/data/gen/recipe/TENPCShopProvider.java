...
//                                .setTitle("title.terra_entity.npc_trade.task.fishman")
        ...
        shop((TENpcEntities.ARMS_DEALER.getId())).addRecipe(builder()
                ...
                .add(ItemListTradeItem.builder(TEItemUtil.make(Items.TIPPED_ARROW, 4, stack -> {
//                    stack.set(DataComponents.POTION_CONTENTS, PotionContents.EMPTY.withPotion(Potions.POISON))
                                }))
                ...
                .add(ItemListTradeItem.builder(TEItemUtil.make(Items.TIPPED_ARROW, 4, stack -> {
//                    stack.set(DataComponents.POTION_CONTENTS, PotionContents.EMPTY.withPotion(Potions.SLOWNESS))
                                }))
                        .addCost(Items.ARROW, 4)
                        .addCost(Items.SPIDER_EYE, 1)
                        .build()
                ...
                .add(ItemListTradeItem.builder(TEItemUtil.make(Items.TIPPED_ARROW, 4, stack -> {
//                    stack.set(DataComponents.POTION_CONTENTS, PotionContents.EMPTY.withPotion(Potions.SLOW_FALLING))
                                }))
                        .addCost(Items.ARROW, 4)
