...
public class TEBossEntities {
    ...
    public static void registerEntityAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(TEBossEntities.QUEEN_BEE.get(), LibUtils.forMixin$ModifyExpression(AttBuilder.createBoss(14,1237, 8).build()));
        event.put(TEBossEntities.SKELETRON.get(), LibUtils.forMixin$ModifyExpression(AttBuilder.createBoss(18.2,2288, 10).build()));
