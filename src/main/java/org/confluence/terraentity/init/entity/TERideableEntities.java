...
public class TERideableEntities {
    ...
    public static final RegistryObject<EntityType<RideableSlime>> RIDEABLE_SLIME = TEEntities.registerCreature("rideable_slime", RideableSlime::new,0.5F,0.5F);
    public static final RegistryObject<EntityType<RideableBee>> RIDEABLE_BEE = TEEntities.registerCreature("rideable_bee", RideableBee::new,0.5F,0.5F);
