...
public class TESummonItems {
    ...
    public static final DeferredItem<Item> SCULK_WISP_STAFF = ITEMS.register("sculk_wisp_staff", () -> new SummonItem<>(new Item.Properties(), TESummonEntities.SCULK_WISP, 2, 8));
