...
public class TESummonItems {
    ...
    public static final DeferredItem<Item> SCULK_WISP_STAFF = ITEMS.register("sculk_wisp_staff", () -> new SummonItem<>(new Item.Properties(), TESummonEntities.SCULK_WISP, 1, 8));
    public static final DeferredItem<Item> IMP_STAFF = ITEMS.register("imp_staff", () -> new SummonItem<>(new Item.Properties(), TESummonEntities.IMP, 1, 8));
