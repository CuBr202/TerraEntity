...
public class TESpawnEggItems {
    ...
    public static final RegistryObject<Item> SNATCHER_SPAWN_EGG = registerEgg("snatcher_spawn_egg", TEEntities.SNATCHER, 0xffffff, 0xffffff);
    public static final RegistryObject<Item> MAN_EATER_SPAWN_EGG = registerEgg("man_eater_spawn_egg", TEEntities.MAN_EATER, 0xffffff, 0xffffff);
    ...
    public static final RegistryObject<Item> NYMPH_SPAWN_EGG = registerEgg("nymph_spawn_egg", TEEntities.NYMPH, 0xffffff, 0xffffff);
    ...
    public static final RegistryObject<Item> WANDERING_EYE_FISH_SPAWN_EGG = registerEgg("wandering_eye_fish_spawn_egg", TEEntities.WANDERING_EYE_FISH, 0xffffff, 0xffffff);
