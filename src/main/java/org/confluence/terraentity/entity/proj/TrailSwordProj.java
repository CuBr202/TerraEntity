 ...
 * OBB拖尾剑气
 */
public class TrailSwordProj extends BaseProj<TrailSwordProj> implements IOriented {
    ...
    public void tick() {
        ...
        if (this.getOwner() != null) {
            ...
            // 本地坐标
            Vector3f pos = getModelPosition(this.tickCount).toVector3f().add(offset);
...
//        return this.tickCount;
    ...
    public float updateZRot(int time){
        return 120;
    }
