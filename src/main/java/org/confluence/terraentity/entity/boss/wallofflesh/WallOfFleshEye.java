...
public class WallOfFleshEye extends AbstractTerraBossBase implements Boss {
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide) {
            ...
            summonCD = healthPercent < 0.5f? (int) (summonCDAll * Mth.clamp(healthPercent, 0.2F, 1.0f)) : summonCDAll;
    ...
    public double getEyeY() {
        return this.position().y + this.getBbHeight() * 0.5f;
    }
