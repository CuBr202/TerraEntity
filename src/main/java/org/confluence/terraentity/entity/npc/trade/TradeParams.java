...
public record TradeParams(Map<Integer, Param> params, BitMask bitMask) {
    ...
    public static FriendlyByteBuf.Writer<TradeParams> WRITER = AdapterUtils.CodecWriter(CODEC);
    public static FriendlyByteBuf.Reader<TradeParams> READER = AdapterUtils.CodecReader(CODEC);
