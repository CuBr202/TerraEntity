            ...
            protected boolean customDoAttack(ServerLevel level, AbstractTerraNPC owner, LivingEntity target){
                var tnt = new PrimedTnt(EntityType.TNT, level){
                    ...
                    protected void explode() {
                        ...
                        float f = 4.0F;
                        this.level().explode(this, owner.level().damageSources().explosion(owner,owner), new CustomExplodeCalculator() {
                            ...
                            public float getEntityDamageAmount(Explosion explosion, Entity entity, double originalDamage) {

                                return (float) originalDamage;
                            }
                        }, this.getX(), this.getY(0.0625), this.getZ(), f, false, Level.ExplosionInteraction.TNT);
                    }
                };
