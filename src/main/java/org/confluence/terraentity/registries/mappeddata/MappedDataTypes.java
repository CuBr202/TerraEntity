...
public class MappedDataTypes {
    ...
    public static final Supplier<IForgeRegistry<MappedDataType<?,?>>> REGISTRY = TYPES.makeRegistry(RegistryBuilder::new);

    public static RegistryObject<BossSkillMapDatas.BossSkillType> BOSS_SKILL_MAP_DATAS = TYPES.register("boss_skill_params",
            BossSkillMapDatas::buildType);

    public static RegistryObject<NPCMappedDatas.NPCMappedDataType> NPC_MAP_DATAS = TYPES.register("npc_params",
            NPCMappedDatas::buildType);

    public static RegistryObject<MonsterMappedDatas.MonsterMappedDataType> MONSTER_MAP_DATAS = TYPES.register("monster_params",
            MonsterMappedDatas::buildType);

    public static RegistryObject<WeaponMappedDatas.WeaponMappedDataType> WEAPON_MAP_DATAS = TYPES.register("weapon_params",
