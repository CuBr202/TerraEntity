...
public class EffectStrategy {
     ...
     * <p>possibility 概率</p>
     * */
    public static final FifFunction<MobEffect,Integer,Integer,Integer,Float, BiConsumer<LivingEntity,LivingEntity>> TIME_POSSIBILITY_AMPLIFIER_EFFECT = (effect, ticks, minAmplifier, maxAmplifier, possibility)->
            (owner, entity) ->{
    ...
    /**概率附加ticks的效果*/
    public static final TriFunction<MobEffect,Integer,Float, BiConsumer<LivingEntity,LivingEntity>> TIME_POSSIBILITY_EFFECT = (effect, ticks, possibility)->
            TIME_POSSIBILITY_AMPLIFIER_EFFECT.apply(effect, ticks, 0,0, possibility);


    /**附加ticks的效果*/
    public static final BiFunction<MobEffect,Integer, BiConsumer<LivingEntity,LivingEntity>> TIME_EFFECT = (effect, ticks)->
            TIME_POSSIBILITY_EFFECT.apply(effect, ticks, 1f);

    /**概率附加随机效果*/
    public static final Function<Map<EffectStrategy, Float>, EffectStrategy> RANDOM_POSSIBILITY_EFFECT = (consumer_map)->
